...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:ankor_user')->group(function () {
        ...
        // CAMBIO AQUÍ: Quité 'destroy' del except para que puedas borrar solicitudes si te equivocas
        Route::resource('solicitudes-presupuesto', SolicitudPresupuestoController::class)->except(['edit', 'update']); 
